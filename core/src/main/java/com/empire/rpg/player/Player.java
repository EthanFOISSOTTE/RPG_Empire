...
public class Player {
    ...
    // Constructeur qui initialise le joueur à une position donnée avec l'échelle par défaut
    public Player(float x, float y) {
        this(x, y, Constants.PLAYER_SCALE);
    }

    // Constructeur principal qui initialise le joueur avec une position et une échelle données
